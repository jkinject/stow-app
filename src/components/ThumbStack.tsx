 ...
 *
 * ⚠ 폭은 **실제 장수만큼**이다. 한때 최대 장수(3)에 맞춰 고정해 뒀는데, 그건 사진이
 *   줄 **왼쪽**에 있어 글자 시작선을 맞춰야 하던 시절의 값이다. 오른쪽으로 옮긴 뒤로는
 *   그 폭이 하는 일이 없고, 한 장짜리 줄의 **왼쪽에 빈 칸만** 만들었다
 *   (사용자 보고 2026-09-02). 줄 오른쪽 끝은 이 컴포넌트가 마지막 요소라 저절로 맞는다.
...
export function ThumbStack({
  ...
  const width = size + step * (list.length - 1);
