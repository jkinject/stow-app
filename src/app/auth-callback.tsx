 ...
 *
 *   메일 속 링크(가입 인증)는 다르다. **외부 브라우저**에서 열려 앱을 딥링크로
 *   깨우므로, 돌아온 URL 을 받아 줄 사람이 이 화면밖에 없다. 그런데 아무도 안
 *   받았으니 메일 링크 로그인은 처음부터 완성된 적이 없었다(2026-09-01 보안 점검
 *   중 발견). 매직링크는 그 뒤 지웠지만(2026-09-09) 가입 인증 링크가 같은 길을 탄다.
 *
