...
import { overlay, radius, type, useTheme } from '@/lib/theme';
...
const st = StyleSheet.create({
  ...
  pathHint: { fontSize: type.tiny, fontWeight: '600', letterSpacing: 0.6, marginBottom: 2 },
  path: { fontSize: type.title, fontWeight: '700', letterSpacing: -0.3, lineHeight: 25 },
  moveBtn: { borderWidth: 1, borderRadius: radius.sm, paddingHorizontal: 14, paddingVertical: 7 },
  moveText: { fontSize: type.small, fontWeight: '600' },
  qtyBox: { borderRadius: radius.md, padding: 16, gap: 10 },
  ...
  selectRow: { flexDirection: 'row', gap: 8, alignItems: 'stretch' },
  select: {
    flex: 1,
    borderWidth: 1,
    borderRadius: radius.sm,
  ...
  danger: { marginTop: 24 },
  gone: { paddingHorizontal: 24, paddingTop: 60, gap: 10 },
  goneTitle: { fontSize: type.title, fontWeight: '700' },
  goneHint: { fontSize: type.body, lineHeight: 22, marginBottom: 16 },
});
