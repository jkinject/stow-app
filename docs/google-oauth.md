...
> Apple 로그인(2026-08-28 에 연기했던 것)은 2026-09-18 에 넣었습니다 — iOS 는 네이티브 흐름이라
> 이 문서의 브라우저 OAuth 설정과 무관합니다. `src/lib/auth.tsx` 머리말과
> [ios-release-checklist.md](ios-release-checklist.md) 참고.
...
| iOS 심사 반려 4.8 | Sign in with Apple 추가로 해소 (2026-09-18, R24) |
