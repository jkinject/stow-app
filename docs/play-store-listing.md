...
> "낯선 위치" 로 판단해 차단합니다. 매직링크도 심사자가 메일함에 못 들어가서 안 됩니다.
> **이메일 + 비밀번호** 만이 외부 의존 없이 동작합니다 — 그래서 이 방식을 넣었습니다.

### 심사용 계정 만들기
1. 앱에서 **이메일로 계속하기 → 계정이 없나요? 가입하기**
2. `jkinject+review@gmail.com` 처럼 **별칭 주소**를 씁니다 (본인 메일함으로 옵니다)
3. 받은 인증 메일의 링크를 눌러 가입을 마칩니다 — **한 번만 하면 됩니다**
4. 장소 3~4개, 박스 2개, 물건 10개쯤 넣어 둡니다. 심사자가 기능을 다 볼 수 있어야
   통과가 빠릅니다
